...
SET ANSI_NULLS ON
GO
CREATE VIEW [mdm].[viw_SYSTEM_3_24_COLLECTIONPARENTCHILD]  
            AS  
            SELECT  
                tCM.Version_ID,   
