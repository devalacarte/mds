...
SET ANSI_NULLS ON
GO
CREATE VIEW [mdm].[viw_SYSTEM_4_34_LEVELS]  
				/*WITH ENCRYPTION*/   
				AS SELECT  
				...
				LEFT JOIN mdm.[tbl_4_34_HP] AS HP0 ON H0.Version_ID = HP0.Version_ID   
					...
					LEFT JOIN mdm.[tbl_4_34_EN] EN10   
					...
					LEFT JOIN mdm.[tbl_4_34_HP] HP10   
					...
					LEFT JOIN mdm.[tbl_4_34_EN] EN11   
					...
					LEFT JOIN mdm.[tbl_4_34_HP] HP11   
