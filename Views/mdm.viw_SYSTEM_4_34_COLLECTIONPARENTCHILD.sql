...
SET ANSI_NULLS ON
GO
CREATE VIEW [mdm].[viw_SYSTEM_4_34_COLLECTIONPARENTCHILD]  
            AS  
            SELECT  
                tCM.Version_ID,   
