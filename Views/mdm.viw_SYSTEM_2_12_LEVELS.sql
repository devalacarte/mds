...
SET ANSI_NULLS ON
GO
CREATE VIEW [mdm].[viw_SYSTEM_2_12_LEVELS]  
				/*WITH ENCRYPTION*/   
				AS SELECT  
				...
				LEFT JOIN mdm.[tbl_2_12_HP] AS HP0 ON H0.Version_ID = HP0.Version_ID   
					...
					LEFT JOIN mdm.[tbl_2_12_EN] EN10   
					...
					LEFT JOIN mdm.[tbl_2_12_HP] HP10   
					...
					LEFT JOIN mdm.[tbl_2_12_EN] EN11   
					...
					LEFT JOIN mdm.[tbl_2_12_HP] HP11   
