...
SET ANSI_NULLS ON
GO
CREATE VIEW [mdm].[viw_SYSTEM_4_37_CHILDATTRIBUTES]  
                ...
                --Custom attributes  
                            ,T.[Name] AS [Name]  
                            ,T.[Code] AS [Code]  
                            ,[SubClass].Code AS [SubClass]  
                            ,[SubClass].ID AS [SubClass.ID]  
                            ,[SubClass].Code AS [SubClass.Code]  
                            ,[SubClass].Name AS [SubClass.Name]  
                FROM mdm.[tbl_4_37_EN] AS T  
            ...
            LEFT JOIN mdm.tblModelVersion lcv ON T.LastChgVersionID = lcv.ID  
                        ...
                        LEFT JOIN mdm.[tbl_4_41_EN] AS [SubClass] ON [SubClass].ID = T.[uda_37_940]   
                            AND [SubClass].Version_ID = T.Version_ID  
                WHERE T.Status_ID = 1;
GO
