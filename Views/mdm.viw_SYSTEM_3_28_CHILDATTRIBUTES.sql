...
SET ANSI_NULLS ON
GO
CREATE VIEW [mdm].[viw_SYSTEM_3_28_CHILDATTRIBUTES]  
                ...
                --Custom attributes  
                            ,T.[Name] AS [Name]  
                            ,T.[Code] AS [Code]  
                            ,[ProductCategory].Code AS [ProductCategory]  
                            ,[ProductCategory].ID AS [ProductCategory.ID]  
                            ,[ProductCategory].Code AS [ProductCategory.Code]  
                            ,[ProductCategory].Name AS [ProductCategory.Name]  
                FROM mdm.[tbl_3_28_EN] AS T  
            ...
            LEFT JOIN mdm.tblModelVersion lcv ON T.LastChgVersionID = lcv.ID  
                        ...
                        LEFT JOIN mdm.[tbl_3_25_EN] AS [ProductCategory] ON [ProductCategory].ID = T.[uda_28_716]   
                            AND [ProductCategory].Version_ID = T.Version_ID  
                WHERE T.Status_ID = 1;
GO
