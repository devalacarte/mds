...
SET ANSI_NULLS ON
GO
CREATE VIEW [mdm].[viw_SYSTEM_2_12_PARENTCHILD]  
            AS  
            SELECT       
                    HR.ID as HR_ID,  
