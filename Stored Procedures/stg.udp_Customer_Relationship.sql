...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [stg].[udp_Customer_Relationship]    
...
BEGIN    
    ...
    IF LEN(@BatchTag) > 0 BEGIN  
        SELECT @MemberCount = COUNT(ID) FROM [stg].[Customer_Relationship]   
    ...
    IF LEN(@BatchTag) > 0 BEGIN  
        IF EXISTS (SELECT stgr.ID FROM [stg].[Customer_Relationship] stgr  
    ...
    BEGIN TRY  
        ...
        -- Create a new batch ID.  
            ...
            IF @GetNewBatch_ID = @BatchIDNotFound BEGIN  
                UPDATE [stg].[Customer_Relationship]  
        ...
        UPDATE [stg].[Customer_Relationship]  
            ...
            WHERE ChildCode IN  
                (SELECT DISTINCT stgr.ChildCode FROM [stg].[Customer_Relationship] stgr  
                INNER JOIN mdm.[tbl_2_12_EN] en ON stgr.ChildCode = en.Code WHERE en.Version_ID = @Version_ID AND en.Status_ID = 2)  
        ...
        UPDATE [stg].[Customer_Relationship]  
            ...
            WHERE ChildCode NOT IN  
                (SELECT DISTINCT stgr.ChildCode FROM [stg].[Customer_Relationship] stgr  
                INNER JOIN mdm.[tbl_2_12_EN] en ON stgr.ChildCode = en.Code WHERE en.Version_ID = @Version_ID)  
        ...
        UPDATE [stg].[Customer_Relationship]  
            ...
            WHERE ParentCode <> N'ROOT' AND ParentCode NOT IN  
                (SELECT DISTINCT stgr.ParentCode FROM [stg].[Customer_Relationship] stgr  
                 INNER JOIN mdm.[tbl_2_12_HP] hp   
        ...
        UPDATE [stg].[Customer_Relationship]  
            ...
            WHERE ParentCode IN  
                (SELECT DISTINCT stgr.ParentCode FROM [stg].[Customer_Relationship] stgr  
                INNER JOIN mdm.[tbl_2_12_EN] en ON stgr.ParentCode = en.Code WHERE en.Version_ID = @Version_ID)  
                AND ImportStatus_ID = @StatusDefault AND Batch_ID = @Batch_ID AND RelationshipType = 1;  
        ...
        WHILE EXISTS(SELECT 1 FROM @tblMeta) BEGIN  
            ...
            */  
            ...
            INNER JOIN mdm.[tbl_2_12_EN] AS tSource   
            ...
            FROM #tblStage AS tStage  
            INNER JOIN mdm.[tbl_2_12_HP] AS tSource   
                ON tStage.Member_Code = tSource.Code   
            WHERE tSource.Version_ID = @Version_ID  
            ...
            */  
            ...
            IF @TargetType_ID = 2 BEGIN  
                ...
                FROM #tblStage AS tStage   
                INNER JOIN mdm.[tbl_2_12_HR] AS tRel   
            ...
            FROM #tblStage AS tStage   
            INNER JOIN mdm.[tbl_2_12_HR] AS tSource   
            ...
            */              
            ...
            SELECT @MaxSortOrderRelationship = MAX(tSource.SortOrder)   
                    FROM mdm.[tbl_2_12_HR] AS tSource  
            ...
            */  
            ...
            FROM [stg].[Customer_Relationship] AS stgr  
        ...
        */  
        ...
        SELECT @ErrorCount = COUNT(ID) FROM [stg].[Customer_Relationship]  
