...
/*  
    ...
    SELECT mdm.udfMetadataDerivedHierarchiesGetIdentifiersXML(1, NULL, N'<Identifier><Muid>424DCCCC-3320-4F76-81EA-06D3D5376A5B</Muid></Identifier>', 2, 2)  
*/  
/*  
==============================================================================  
...
==============================================================================  
*/  
CREATE FUNCTION [mdm].[udfMetadataDerivedHierarchiesGetIdentifiersXML]  
(  
    @User_ID        INT,  
    @ModelIDs       XML = NULL,  
