...
GO
/*  
    Returns a serialized Entity business entity object with only identifiers.  
*/  
/*  
==============================================================================  
...
CREATE FUNCTION [mdm].[udfMetadataEntityGetIdentifiersXML]  
(  
    @User_ID            INT,  
    @ModelIDs           XML = NULL,  
    @EntityIDs          XML = NULL,  
...
AS BEGIN  
    ...
    SELECT @Return = CONVERT(XML, (  
      SELECT      
        ...
        -- Core.BusinessEntities.Entity members                    
